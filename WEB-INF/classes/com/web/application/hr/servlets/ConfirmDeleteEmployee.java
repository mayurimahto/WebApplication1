	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
	{
		try
		{
			...
			try
			{
				...
				pw.println("<form method='post' action='/WebApplication1/deleteEmployee'>");
				...
				{
					pw.println("<b>Overseas</b><br>");
				}
				pw.println("Basic salary : ");
				pw.println("<b>"+employeeDTO.getBasicSalary()+"</b><br>");
			...
			{
				//send back view page
				// when getByEmployeeId is called and employeeId is not found
				//employeesView
